    ...
    <div className="mt-20 font-poppins">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-10 mx-10 md:mx-20">
        <img
          ...
          width={100}
          height={100}
          className="w-[90%] md:w-[80%] mx-auto rounded-xl"
        />
        <div>
          <h1 className="text-2xl my-6 font-medium">Padikkal</h1>
          <p className="font-light text-[#A9A9A9] text-lg leading-8 text-justify mb-8">
          ...
          <Link href={'/about'} className="border-2 border-secondary px-4 py-2 text-secondary rounded-md mt-8">Learn more</Link>
        </div>
      </div>
    </div>
  );
